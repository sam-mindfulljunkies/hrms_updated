<nav id="sidebar" class="sidebar">
			...
			<div class="sidebar-content js-simplebar">
				...
				<ul class="sidebar-nav">
					...
					<li @if(Route::currentRouteName() == 'listing.leave') class="sidebar-item active" @elseclass="sidebar-item " @endif>

						<a href="{{route('listing.leave')}}" class="sidebar-link">

							<i class="align-middle" data-feather="bell"></i> <span class="align-middle">Leave Approvals</span>
					...
					@if(Auth::guard('admin')->user()->role_id == 2)
					 ...
					 <li @if(Route::currentRouteName() == 'user_profile') class="sidebar-item active" @elseclass="sidebar-item " @endif>
						...
						<a class="sidebar-link" href="{{route('user_profile')}}">
							...
							<i class="align-middle" data-feather="home"></i> <span class="align-middle">My Profile</span>
