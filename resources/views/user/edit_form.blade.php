...
<main class="content">
    <div class="container-fluid p-0">
        ...
        <a class="btn btn-primary mt-4" href="{{ URL::previous() }}" style="right:4%;position:absolute;z-index:9">Go
            back</a>
        @else
        <a class="btn btn-primary mt-4" href="{{ URL::previous() }}" style="right:4%;position:absolute;z-index:9">Go
            back</a>
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-4 form-group">
                                    ...
                                    <input type="text" name="fname" class="form-control" id="fname"
                                        placeholder="Fitst Name" value="{{$user->fname}}">
                                </div>
                                <div class="mb-3 col-md-4 form-group">
...
$(document).ready(function() {
    ...
    $('#user_register').validate({
        ...
        messages: {
            ...
            countryCode: {
                required: "Country Code is reqiured",
            },
            aadhar:{
                required: "Aadhar Uploadation should be required",
                extension: "Valid only Jpg png or Pdf files",
            }
        },
        errorElement: 'span',
